...
const fetchRecoveryPassword = ref(false)
const recoveryPasswordForm = ref(null)
const isSuccess = ref(false)
const errorMessage = ref(null)
const errorClose = ref(null)
const errorText = ref(null)

const recoveryPasswordInitialState = {
  email: '',
}
const recoveryPasswordData = reactive({ ...recoveryPasswordInitialState })
...
function recoveryPassword () {
  if (!recoveryPasswordForm.value.checkValidity()) {
    return
  }
  ...
  <div>
    ...
    <div class="flex flex-col md:flex-row items-center justify-between">
      <div class="flex flex-col w-full md:w-4/12 justify-center px-10 md:pl-20 mb-10">
        <div class="flex flex-col mt-10 md:mt-3" v-show="!fetchRecoveryPassword && isSuccess">
        ...
        >
          ...
          <div class="flex flex-col space-y-3 relative">
            ...
            <input
              id="email"
              type="email"
              v-model="recoveryPasswordData.email"
              required
          ...
          <div>
            <button type="submit" class="mt-10 w-full">
              <div class="relative">
                <div class="flex flex-row h-full items-center px-6 justify-between z-10 absolute w-full" v-show="!fetchRecoveryPassword">
                  <div class="font-action text-white text-3xl">Recuperar</div>
                  <div>
                ...
                <div class="flex flex-col items-center h-full px-6 justify-between z-10 top-3 absolute w-full" v-show="fetchRecoveryPassword">
                  <div>
